...
Let \coqdocvar{compute\_ltsR} be the function that implements the idea described in the previous paragraph, the following Coq command computes the set of transitions of ``P''.
...
%TODO -- stopped here
% comment on well-founded recursion
% comment on creating an heuristic for $n$
