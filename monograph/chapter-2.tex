...
Consider the following example extracted from \citeonline{Pierce:SF4}. The function \emph{remove} takes a natural number $ x $ and a list of natural numbers $ l $ and removes $ x $ from the list.
